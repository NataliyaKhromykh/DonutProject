        ...
        return(
            <div className='modal'>
                <div className='overlay' onClick={closeModal}>
                    ...
                    <h1 className='modalTwoText'>Once upon a time, five years ago, the aroma of warm, sugary dreams filled the air as me and my mom embarked on a delightful journey together. With aprons tied and hearts full of shared enthusiasm, the two of us opened the doors to a cozy haven of sweetness – your very own donut shop.
...
And so, the tale of your sweet venture continued to unfold, with the donut shop becoming a cherished chapter in the story of our family's shared success and the enduring joy that flourished with each batch of freshly baked memories.</h1>
                    </div>
                    <span class="btn" onClick={()=> setTwoIsOpen(true)}>&times;</span>
                </div>
            </div>
        )
    }
